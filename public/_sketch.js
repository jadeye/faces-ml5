...
function displayExpressions(expressions) {
  const heightEmotionScroe = Object.keys(expressions).reduce(function (a, b) { return obj[a] > obj[b] ? a : b });
  document.getElementsByClassName("expressions")[0].innerHTML = `${JSON.stringify(heightEmotionScroe)}`
}
